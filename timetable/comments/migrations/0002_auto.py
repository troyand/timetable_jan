...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'LessonComment', fields ['ip']
        db.create_index('comments_lessoncomment', ['ip'])

    def backwards(self, orm):
        # Removing index on 'LessonComment', fields ['ip']
        db.delete_index('comments_lessoncomment', ['ip'])

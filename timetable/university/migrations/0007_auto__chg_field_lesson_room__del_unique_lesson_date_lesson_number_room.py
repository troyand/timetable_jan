...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Lesson', fields ['date', 'lesson_number', 'room']
        db.delete_unique('university_lesson', ['date', 'lesson_number', 'room_id'])


        # Changing field 'Lesson.room'
        db.alter_column('university_lesson', 'room_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['university.Room'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Lesson.room'
        raise RuntimeError("Cannot reverse this migration. 'Lesson.room' and its values cannot be restored.")
        # Adding unique constraint on 'Lesson', fields ['date', 'lesson_number', 'room']
        db.create_unique('university_lesson', ['date', 'lesson_number', 'room_id'])
    ...
    models = {
        ...
        'university.lesson': {
            ...
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['university.Room']", 'null': 'True', 'blank': 'True'})
        },
        'university.major': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timetable.academic_term'
        db.add_column('university_timetable', 'academic_term',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['university.AcademicTerm']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Timetable.academic_term'
        db.delete_column('university_timetable', 'academic_term_id')

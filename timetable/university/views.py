...
promos = {
    ...
    datetime.date(2012, 11, 23): [
        ('img/promo/pnp1.png', 'https://www.facebook.com/events/375917609159223/'),
    ],
    ...
    datetime.date(2012, 12, 6): [
        ('img/promo/kvartyrnyk.png', 'https://www.facebook.com/events/501276519893204/'),
    ],
    datetime.date(2012, 12, 7): [
        ('img/promo/sb15.png', 'https://www.facebook.com/events/497830043594671/'),
    ],
    ...
    datetime.date(2013, 6, 15): [
        ('img/promo/flower_ballroom_party_2013.png', 'https://vk.com/kvitkovyi_bal'),
    ],
    datetime.date(2013, 6, 18): [
        ('img/promo/miss_2013.png', 'https://www.facebook.com/events/146530922206084/'),
    ],
}

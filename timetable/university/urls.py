...
urlpatterns = patterns('',
    ...
    (r'^planning-light/room/(?P<room_id>\d+)/$', 'timetable.university.views.planning_light_room'),
    (r'^planning-light/room/(?P<room_id>\d+)/ajax/$', 'timetable.university.views.planning_room_ajax'),

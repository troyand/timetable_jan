...
urlpatterns = patterns('',
    ...
    (r'^planning/(?P<term>\d+)/$', 'timetable.university.views.planning'),
    (r'^planning/$', 'timetable.university.views.choose_term_for_planning'),
    ...
    (r'^planning-light/(?P<room_id>\d+)/$',
     'timetable.university.views.planning_ajax'),
    (r'^planning-light/room/(?P<room_id>\d+)/$',
     'timetable.university.views.planning_light_room'),
    ('^planning-light/room/(?P<room_id>\d+)/ajax/$',
     'timetable.university.views.planning_room_ajax'),

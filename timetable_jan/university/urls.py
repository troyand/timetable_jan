...
urlpatterns = patterns('',
    ...
    url(r'^render/(?P<encoded_groups>[\d/]+)/group/(?P<group_to_show>\d+)/$', 'timetable_jan.university.views.timetable', {'action': 'render'}, name='render'),
    url(r'^render/(?P<encoded_groups>[\d/]+)/week/(?P<week_to_show>\d+)/$', 'timetable_jan.university.views.timetable', {'action': 'render'}, name='render'),
    url(r'^render/(?P<encoded_groups>[\d/]+)/week/(?P<week_to_show>\d+)/group/(?P<group_to_show>\d+)/$', 'timetable_jan.university.views.timetable', {'action': 'render'}, name='render'),

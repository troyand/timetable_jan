...
urlpatterns = patterns('',
    ...
    url(r'^render/(?P<encoded_groups>[\d/]+)/$', 'timetable_jan.university.views.timetable_index', {'action': 'render'}, name='render-index'),
    url(r'^render/(?P<encoded_groups>[\d/]+)/group/(?P<group_to_show>\d+)/$', 'timetable_jan.university.views.timetable_index', {'action': 'render'}, name='render-index-group'),
    url(r'^render/(?P<encoded_groups>[\d/]+)/weeks/$', 'timetable_jan.university.views.timetable', {'action': 'render'}, name='render-all'),
    url(r'^render/(?P<encoded_groups>[\d/]+)/weeks/group/(?P<group_to_show>\d+)/$', 'timetable_jan.university.views.timetable', {'action': 'render'}, name='render-all-group'),
